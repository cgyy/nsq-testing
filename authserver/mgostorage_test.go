...
func initTestStorage() *authserver.MongoStorage {
	return authserver.NewMongoStorage(session, selectUniqueDbName())
}
...
func deleteTestDatabase(storage *authserver.MongoStorage) {
...
func setClient1234(storage *authserver.MongoStorage) (osin.Client, error) {
...
func TestGetClient(t *testing.T) {
	...
	log.Println("client id =", client.GetId())
